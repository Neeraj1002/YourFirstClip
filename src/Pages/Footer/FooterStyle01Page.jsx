  ...
  return (
    <div style={props.style}>
      ...
      <section className="py-[130px] lg:py-[90px] md:py-[75px] sm:py-[50px] bg-white">
        <Container>
          <IconWithText
            grid="row-cols-1 row-cols-lg-4 row-cols-sm-2 gap-y-5"
            theme="icon-with-text-03 text-center"
      ...
      <section className="bg-[#f7f8fc] py-[130px] lg:py-[90px] md:py-[75px] sm:py-[50px]">
        <Container>
          <Row className="justify-center">
            <m.div
              className="text-center mb-20 col-xl-5 col-lg-6 col-sm-8"
              {...fadeIn}
            >
              <span className="text-center font-serif text-md inline-block font-medium text-gradient bg-gradient-to-r from-[#556fff] via-[#e05fc4] to-[#ff798e] uppercase mb-[20px] sm:mb-[15px]">
                {" "}
                What people are saying{" "}
              </span>
              <h5 className="font-serif text-[2.3rem] justify-center text-center text-darkgray font-semibold -tracking-[1px]">
                {" "}
