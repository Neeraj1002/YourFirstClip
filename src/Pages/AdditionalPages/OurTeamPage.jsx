...
const OurTeamPage = (props) => {
  ...
  return (
    <div style={props.style}>
      ...
      {/* Section Start */}
      <m.section
        className="overflow-hidden pt-[130px] pb-[100px] lg:py-[90px] md:py-[70px] sm:py-[50px] relative bg-cover bg-center bg-no-repeat bg-fixed lg:bg-local"
        style={{ backgroundImage: "url(/assets/img/webp/our-team-bg2.webp)" }}
        {...fadeIn}
      >
        <Container fluid className="text-center">
          <Row>
            <Col className="text-center mb-28 z-0 lg:mb-12 md:mb-20">
              <TiltBox>
                <div className="mb-[20px] block">
                  <span className="font-serif font-medium text-white uppercase tracking-[1px] text-sm bg-darkgray inline-block px-[20px] py-[5px]">
                    We are litho highly creative team
                  </span>
                </div>
                <span
                  className="font-serif title cover-background font-bold text-center text-[230px] leading-[230px] -tracking-[5px] uppercase bg-darkgray lg:text-[170px] lg:leading-[170px] md:text-[130px] md:leading-[130px] sm:text-[100px] sm:leading-[100px] xs:text-[55px] xs:leading-[55px] xs:-tracking-[1px]"
                  style={{
                    backgroundImage: `url(https://via.placeholder.com/1920x1091)`,
                  }}
                >
                  Together
                </span>
            ...
            <ScrollTo
              ...
              smooth={true}
              duration={800}
              className="absolute justify-center bottom-[50px] left-1/2 w-[45px] px-0 flex h-[45px] -translate-x-1/2 sm:bottom-7 box-shadow-small rounded-full cursor-pointer"
            >
        ...
        <div className="bg-gradient-to-tr from-[#f5bb8d] via-[#ffaea8] to-[#f3aaca] rounded-[5px] overflow-hidden pt-36 md:pt-[72px] sm:pt-24">
          <Container>
            <Row className="justify-center items-center">
              <m.div
                className="font-medium text-darkgray font-serif pb-[100px] lg:pb-[70px] ml-[97px] lg:ml-[0px] md:text-center col-xl-5 col-lg-6 col-md-7 order-lg-2"
                {...{ ...fadeIn, transition: { delay: 0.5 } }}
              >
                <span className="mb-[35px] text-lg inline-block relative whitespace-nowrap border-b border-solid border-darkgray md:text-xmd">
                  Awesomeness and creative people
                </span>
                <h4 className="-tracking-[.5px] mb-[45px] xs:w-[99%]">
                  Teamwork is the ability work together toward a{" "}
                  <span className="font-semibold">common vision</span>
                </h4>
                <ScrollTo
                  to="position-open"
                  offset={0}
                ...
                >
                  <Buttons
                    ariaLabel="button"
                    className="font-medium font-serif uppercase hover:text-white btn-expand"
                    size="lg"
                    color="#fff"
                    themeColor="#232323"
                    title="Join the people"
                  />
                </ScrollTo>
              </m.div>
              <Col
              ...
              >
                <m.img
                  loading="lazy"
                  src="https://via.placeholder.com/406x506"
                  width="406"
                  height="506"
                  alt="Our Team"
                  className="mx-auto"
      ...
      {/* Section Start */}
      <m.section
        className="overflow-hidden py-[160px] lg:py-[120px] md:py-[95px] sm:py-[80px] xs:py-[50px]"
        {...fadeIn}
      >
        <Container>
          <Row className="items-end">
            <Col className="col-12 col-xl-3 col-lg-4 relative pt-8 md:mb-16">
              <span className="font-serif font-medium text-fastblue block mb-[20px]">
                Loved by our team
              </span>
              <h6 className="font-serif font-medium text-darkgray -tracking-[.5px] mb-14 lg:w-[90%]">
                What our employee are saying about us?
              </h6>
              <div className="flex">
                <div
                  onClick={() => swiperRef.current.swiper.slidePrev()}
                  className="btn-slider-next rounded-full flex justify-center items-center text-black hover:shadow-[0_0_15px_rgba(0,0,0,0.1)] bg-white right-inherit left-[65px] h-[40px] border border-mediumgray w-[40px] cursor-pointer"
                >
                ...
                <div
                  ...
                  className="btn-slider-prev rounded-full flex justify-center items-center text-black right-inherit h-[40px] w-[40px] hover:shadow-[0_0_15px_rgba(0,0,0,0.1)] border border-mediumgray ml-[10px] cursor-pointer"
                >
                  <button className="text-xmd">
                      ...
                      <div className="py-12 px-12 px-mb-14 bg-white border border-mediumgray rounded-[6px] md:py-8 md:px-[2.5rem]">
                        <div className="flex">
                          ...
                          <div className="">
                            ...
                            <div className="text-darkgray text-md font-serif font-medium leading-[12px]">
                              {item.name}
                            </div>
                            {item.company && (
      ...
      {/* Section Start */}
      <m.section
        className="overflow-hidden rounded-[5px] relative py-0 mx-[7%] xl:mx-[3%] md:mx-[2.5rem] sm:m-0"
        {...fadeIn}
      >
              ...
              return (
                <SwiperSlide key={i} className="h-full">
                  <img
                    ...
                    alt="contac-us"
                    src={item.img}
                    className="cover-background my-0 mx-auto w-full h-full object-cover"
                  />
                </SwiperSlide>
              );
            })}
      ...
      <section
        id="position-open"
        className="py-[130px] lg:pt-[90px] lg:pb-[80px] md:pt-[75px] md:pb-[100px] sm:pt-[50px]"
      >
        <Container>
          <m.div
          ...
          >
            <Col lg={5} sm={7} className="col-12 text-center mb-20 sm:mb-12">
              <span className="font-serif font-medium text-fastblue block mb-[15px]">
                Opening positions
              </span>
              <h5 className="font-serif font-medium text-darkgray inline-block -tracking-[.5px]">
