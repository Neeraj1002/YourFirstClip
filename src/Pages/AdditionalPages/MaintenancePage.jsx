...
const MaintenancePage = () => {
  return (
    <div>
      <section
        className="overflow-hidden relative px-[130px] lg:px-[0px]"
        style={{
          backgroundImage:
            "linear-gradient(to right top,#0039e3,#4132e0,#5e28dd,#741bd9,#8600d4)",
        }}
      >
        {/* Big Circle */}
        <m.svg
        ...
        <Container fluid className="relative">
          <Row className="items-center h-[100vh] landscape:md:h-auto sm:items-start xs:h-auto mxl:justify-center">
            <Col
              md={6}
              xs={12}
              className="text-[#fff] font-serif flex flex-col justify-between items-start sm:items-center sm:text-center sm:px-[100px] sm:pt-[50px] sm:pb-0 sm:h-auto xs:px-[20px] h-full py-[90px]"
            >
              <Link
                aria-label="homepage"
                to="/"
                className="inline-block mb-14 sm:flex sm:justify-center xs:mb-[110px]"
              >
                <m.img
                  loading="lazy"
                  alt="logo"
                      ...
                      <div className="relative mb-16 subscribe-style-03">
                        <Form className="relative">
                          <Input
                            ...
                            type="email"
                            name="email"
                            className="border-[1px] border-solid pt-[18px] pr-[145px] pb-[19px] pl-[25px] border-transparent text-darkgray"
                            placeholder="Your email address"
                          />
                          <button
                            type="submit"
                            className={`text-xs tracking-[1px] py-[12px] px-[28px] uppercase !text-fastblue hover:!text-darkgray${
