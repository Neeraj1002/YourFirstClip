...
const AccordionData = [
  {
    ...
    content:
      "Lorem ipsum is simply dummy text of the printing and typesetting industry. Lorem ipsum has been the industry's standard dummy text ever since the 1500s, when an took.",
  },
  {
...
const PricingPackagesPage = (props) => {
  ...
  return (
    <div style={props.style}>
      ...
      <m.div
        className="md:flex md:items-center overflow-hidden relative py-[80px] md:py-[40px]"
        {...fadeIn}
      >
        <Parallax
          className="lg-no-parallax cover-background absolute top-[0px] left-0 w-full h-[100vh]"
          translateY={[-40, 40]}
          style={{
        ...
        <Container>
          <Row className="justify-center items-center h-[400px] xs:h-[280px]">
            <Col
              ...
              lg={7}
              md={10}
              className="relative text-center text-white font-serif"
            >
              <span className="opacity-60 mb-[5px] block xs:leading-[20px]">
                Unlimited customization possibilities
              </span>
              <h1 className="font-medium -tracking-[.5px] text-[42px] leading-[49px] mb-[10px] sm:text-[30px] sm:leading-[40px]">
                Pricing packages
              </h1>
            </Col>
          </Row>
      ...
      {/* Section Start */}
      <m.section
        className="pricingtable-pricingpackages py-[130px] lg:py-[90px] md:py-[75px] sm:py-[50px] bg-lightgray"
        {...fadeIn}
      >
        <Container className="switch-tab">
          <Row className="justify-center">
            <Col xl={5} lg={6} sm={7} className="text-center mb-14">
              <h5 className="font-serif font-medium text-darkgray">
                Choose one of our plans get access to plugins for free
              </h5>
            </Col>
          </Row>
          <Tabs
            className="mb-[105px] md:mb-[50px] sm:mb-[20px]"
            ...
            <Tab eventKey="monthly" title="MONTHLY">
              <Row className="justify-center">
                <PricingTable01
                  ...
                  theme="pricing-table-style-01 col-12 col-lg-4 col-md-8"
                  className=""
        ...
        <Container>
          <Row className="items-end">
            <Col className="col-12 col-xl-3 col-lg-4 relative pt-8 md:mb-16">
              <span className="font-serif font-medium text-fastblue block mb-[20px] lg:mb-[15px]">
              ...
              <div className="flex">
                <div
                  ...
                  className="btn-slider-next rounded-full flex justify-center items-center text-black hover:shadow-[0_0_15px_rgba(0,0,0,0.1)] bg-white right-inherit border border-mediumgray left-[65px] h-[40px] w-[40px] cursor-pointer"
                >
      ...
      {/* Section Start */}
      <m.section
        className="py-[130px] lg:py-[90px] md:py-[75px] sm:py-[50px] bg-lightgray"
        {...fadeIn}
      >
        <Container>
          <Row className="justify-center">
            <Col
              lg={6}
              className="font-serif text-center mb-[6.5rem] md:mb-[5.5rem] sm:mb-12"
            >
              <h5 className="font-medium text-darkgray mb-[15px] -tracking-[1px]">
              ...
              <span className="font-medium">
                ...
                <Link
                  ...
                  className="text-fastblue font-meidum text-decoration-line-bottom"
                >
                  Contact us
                </Link>
              </span>
            ...
            <Col lg={4} md={5} className="sm:mb-[30px] text-center">
              <div className="feature-box bg-fastblue rounded-[8px] p-12 mb-[30px]">
                ...
                <div className="feature-box-content ">
                  <span className="text-white text-xmd block font-serif font-medium">
                    How can we help you?
                  </span>
                  <a
                    aria-label="email"
                    href="mailto:info@yourdomain.com"
                    className="text-white font-serif text-decoration-line-bottom"
                  >
                    Send us an email
                  </a>
                </div>
              ...
              <div className="feature-box bg-white rounded-[8px] p-12">
                ...
                <div className="feature-box-content">
                  <span className="text-darkgray text-xmd block font-serif font-medium">
                    Feel free to get in touch?
                  </span>
                  <Link
                    aria-label="call"
                    to="#"
                    className="font-serif text-decoration-line-bottom"
                  >
