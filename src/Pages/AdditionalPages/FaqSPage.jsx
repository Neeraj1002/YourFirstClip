  ...
  return (
    <div style={props.style}>
      ...
      <div className="md:flex md:items-center overflow-hidden relative py-[80px]">
        <Parallax
          className="lg-no-parallax bg-cover cover-background w-full h-[100vh] absolute top-[0px] left-0 xl:h-[700px] xl:-top-[90px] xs:h-[480px]"
          translateY={[-40, 40]}
          style={{
          ...
          <Row className="justify-center items-center h-[400px] md:h-[320px] xs:h-[200px]">
            ...
            >
              <div className="text-center mb-[40px]">
                <h1 className="text-[42px] leading-[49px] font-serif text-white font-medium mb-0 sm:text-[30px] sm:leading-[40px]">
                  How can we help you?
                </h1>
              </div>
                    ...
                    <div className="relative subscribe-style-05">
                      <Form className="relative">
                        <Input
                          ...
                          type="text"
                          name="search"
                          className="border-[1px] large-input border-solid border-transparent rounded-[4px]"
                          placeholder="Type keywords to find answers"
                        />
                        <button
                          type="submit"
                          className={`text-xs py-[12px] !font-semibold px-[28px] uppercase xs:text-center${
                            isSubmitting ? " loading" : ""
                          }`}
                        >
                          <i className="fas fa-search text-fastblue text-xs leading-none mr-[10px] xs:mr-0"></i>
                          search
                        </button>
                      </Form>
                    </div>
        ...
        <Container fluid className="px-[12%] xl:px-[10%] lg:px-[3%]">
          <Row>
            <Col className="col-12 text-center mb-28">
              <span className="block font-serif mb-[5px]">
                Most common questions
              </span>
              <h5 className="font-serif text-darkgray font-semibold mb-0">
              ...
              return (
                <m.div className="col-12 col-lg-4 col-sm-6" key={i} {...fadeIn}>
                  <div className="faqs-page-list bg-white rounded box-shadow-small p-16 lg:p-12 h-full">
                    <span className="font-serif text-xmd text-darkgray font-medium block mb-[15px]">
                      {item.title}
                    </span>
                    <ul className="p-0 list-style text-start mb-[15px]">
                      {item.content &&
                        item.content.map((item, i) => {
                          return (
                            <li key={i}>
                              <Link to="#" className="hover:text-fastblue">
                                {item}
                              </Link>
                            </li>
                          );
                    ...
                    <Buttons
                      ...
                      href="#"
                      className="font-medium font-serif uppercase btn-link !tracking-[.5px] after:h-[2px] after:bg-fastblue hover:text-fastblue"
                      size="md"
                      color="#0038e3"
      ...
      <section className="py-[130px] lg:py-[90px] md:py-[75px] sm:py-[50px]">
        <Container>
          <Row className="items-center justify-center">
            <Col className="col-12 text-center mb-28">
              <m.span {...fadeIn} className="block font-serif mb-[5px]">
                No helpful answer?
              </m.span>
              <m.h5
                {...{ ...fadeIn, transition: { delay: 0.2 } }}
                className="font-serif text-darkgray font-semibold mb-0"
              >
          ...
          <Row className="justify-center gap-y-[30px]">
            <Col lg={6} md={9}>
              <m.div
                ...
                className="rounded-[4px] bg-fastblue overflow-hidden p-16 flex"
              >
                <div className="mr-[35px]">
                  <i className="line-icon-Hipster-Headphones text-[60px] text-white"></i>
                </div>
                <div className="pl-[15px]">
                  <span className="font-serif text-xmd font-medium mb-[10px] block text-white">
                    Help desk support
                  </span>
                  <p className="text-white opacity-60 w-[90%] lg:w-full mb-[20px]">
                  ...
                  <Buttons
                    ariaLabel="faq"
                    href="#"
                    className="font-medium font-serif uppercase btn-link !tracking-[.5px] after:h-[2px] after:bg-[#fff] hover:opacity-70 hover:text-white"
                    size="xl"
                    color="#fff"
                    title="Browse topics"
                  />
            ...
            <Col lg={6} md={9}>
              <m.div
                ...
                className="rounded-[4px] bg-[#27ae60] overflow-hidden p-16 flex"
              >
                <div className="mr-[35px]">
          ...
          <Row className="items-center justify-center">
            ...
            <Col className="col-12 text-center mt-20">
              <Buttons
                ariaLabel="faq"
                href="#"
                className="mx-3 font-medium font-serif uppercase rounded-none lg:mb-[15px]"
