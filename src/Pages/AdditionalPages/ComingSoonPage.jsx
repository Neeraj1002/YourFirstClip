        ...
        <section className="p-[0px] md:landscape:py-[50px] overflow-hidden bg-[#f5f5f5] flex-1 flex items-center justify-center relative">
          <Row className="justify-center relative z-10">
            ...
            <Col xs={12} className="text-center">
              <m.h1
                ...
                className="inline-block font-serif text-gradient bg-gradient-to-r from-[#b783ff] to-[#ff85a6] font-semibold pb-[10px] xl:text-[50px] xl:leading-none xs:text-[38px]"
              >
                We are <br />
                launching soon
              </m.h1>
              <m.p
                ...
                className="text-xmd w-2/5 mx-auto mb-[30px] xl:text-xs xs:w-[90%]"
              >
          ...
          <div className="h-full w-full min-w-[1500px] absolute bottom-0 left-1/2 -translate-x-1/2">
            <m.img
              {...{
                ...rotateInDown,
                transition: { delay: 3.5, ease: "easeOut", duration: 0.5 },
              }}
              alt="stick"
            ...
            <m.img
              {...{
                ...rotateInDown,
                transition: { delay: 2.7, ease: "easeOut", duration: 0.5 },
              }}
              alt="coffee-cup"
            ...
            <m.img
              {...{
                ...rotateInDown,
                transition: { delay: 2.5, ease: "easeOut", duration: 0.5 },
              }}
              alt="envelope"
                ...
                >
                  {({ isSubmitting, status }) => (
                    <m.div
                      ...
                      className="relative subscribe-style-07 mb-[30px] z-10"
                    >
                      <Form className="relative font-serif">
                        <Input
                          ...
                          type="email"
                          name="email"
                          className="border-[1px] large-input border-solid border-transparent"
                          placeholder="Your email address"
                        />
                        <button
                          type="submit"
                          className={`!text-xs py-[12px] px-[28px] font-medium uppercase${
