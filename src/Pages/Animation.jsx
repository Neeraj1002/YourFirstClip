        ...
        <Container>
          <Row xs={1} className="justify-center divide-y divide-darkgray/20">
            <Col className="font-serif font-semibold text-darkgray text-center py-[11%]">
              <m.h4 className="mb-0" {...bounce}>
                bounce
              </m.h4>
            </Col>
            <Col className="font-serif font-semibold text-darkgray text-center py-[11%]">
              <m.h4 className="mb-0" {...flash}>
                flash
              </m.h4>
            </Col>
            <Col className="font-serif font-semibold text-darkgray text-center py-[11%]">
              <m.h4 className="mb-0" {...pulse}>
                pulse
              </m.h4>
            </Col>
            <Col className="font-serif font-semibold text-darkgray text-center py-[11%]">
              <m.h4 className="mb-0" {...rubberBand}>
                rubberBand
              </m.h4>
            </Col>
            <Col className="font-serif font-semibold text-darkgray text-center py-[11%]">
              <m.h4 className="mb-0" {...fadeIn}>
                fadeIn
              </m.h4>
            </Col>
            <Col className="font-serif font-semibold text-darkgray text-center py-[11%]">
              <m.h4 className="mb-0" {...fadeInUp}>
                fadeInUp
              </m.h4>
            </Col>
            <Col className="font-serif font-semibold text-darkgray text-center py-[11%]">
              <m.h4 className="mb-0" {...fadeInDown}>
                fadeInDown
              </m.h4>
            </Col>
            <Col className="font-serif font-semibold text-darkgray text-center py-[11%]">
              <m.h4 className="mb-0" {...fadeInBlur}>
                fadeInBlur
              </m.h4>
            </Col>
            <Col className="font-serif font-semibold text-darkgray text-center py-[11%]">
              <m.h4 className="mb-0" {...fadeInRight}>
                fadeInRight
              </m.h4>
            </Col>
            <Col className="font-serif font-semibold text-darkgray text-center py-[11%]">
              <m.h4 className="mb-0" {...fadeInLeft}>
                fadeInLeft
              </m.h4>
            </Col>
            <Col className="font-serif font-semibold text-darkgray text-center py-[11%]">
              <m.h4 className="mb-0" {...zoomIn}>
                zoomIn
              </m.h4>
            </Col>
            <Col className="font-serif font-semibold text-darkgray text-center py-[11%]">
              <m.h4 className="mb-0" {...zoomOut}>
                zoomOut
              </m.h4>
            </Col>
            <Col className="font-serif font-semibold text-darkgray text-center py-[11%]">
              <m.h4 className="mb-0" {...rotateInDown}>
                rotateInDown
              </m.h4>
            </Col>
          </Row>
