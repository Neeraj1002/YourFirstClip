...
const BlogMasonrydData = blogData.filter((item) => item.blogType === "classic");
        ...
        <div className="overflow-hidden">
            ...
            <m.section className="py-[130px] overflow-hidden lg:py-[90px] md:py-[75px] sm:py-[50px] border-t border-inherit" {...fadeIn}>
                <Container>
                    ...
                    <Row>
                        <Col className="px-0">
                            <BlogMasonry pagination={false} grid="grid grid-4col xl-grid-4col lg-grid-3col md-grid-2col sm-grid-2col xs-grid-1col gutter-extra-large" data={BlogMasonrydData.slice(0, 4)} />
                        </Col>
                    </Row>
                </Container>
            </m.section>
