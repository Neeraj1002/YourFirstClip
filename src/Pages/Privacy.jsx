...
const ListData = [
  ...
  {
    content:
      "By using our website and agreeing to this policy, you consent to our use of cookies in accordance.",
  },
  {
    content:
    ...
    <div style={props.style}>
      ...
      <Header topSpace={{ desktop: true }} type="reverse-scroll">
        <HeaderNav
          ...
          bg="white"
          menu="light"
          containerClassName="sm:px-0"
          className="px-[35px] py-[0px] md:pr-[15px] md:pl-0"
        >
          ...
          <Navbar.Collapse
            ...
            className="col-auto menu-order justify-end px-0"
          >
            <Menu {...props} />
          </Navbar.Collapse>
        ...
        <Container>
          <Row className="xs:text-center">
            <Col
              xl={8}
              lg={6}
              className="flex md:justify-center md:mb-[15px] sm:block sm:text-center"
            >
              <h1 className="text-lg text-darkgray font-medium mb-0 font-serif inline-block">
                Privacy policy
              </h1>
              <span className="font-serif text-md relative pl-[25px] ml-[25px] block sm:mt-[5px] sm:p-0 before:absolute before:bg-darkgray before:content-[''] before:h-[12px] before:top-[4px] before:w-[2px] before:left-0 sm:before:hidden sm:ml-0">
