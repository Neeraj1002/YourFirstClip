...
const SingleProjectPage03 = (props) => {
  return (
    <div style={props.style}>
      ...
      {/* Section Start */}
      <section
        className="p-0 h-[900px] lg:h-[750px] sm:h-[450px] xs:h-[350px] bg-cover flex items-end overflow-hidden relative bg-center"
        style={{
          backgroundImage: "url('https://via.placeholder.com/1920x915')",
        }}
      >
        <Container>
          <Row className="justify-center">
            <Col lg={12} className="text-center">
              <img
                height=""
                width=""
                src="https://via.placeholder.com/318x500"
                alt=""
                className="w-25 inline-block"
              />
              <h5 className="font-serif text-white mt-20 mb-36 font-semibold uppercase block xs:mt-12 xs:mb-20">
                Gents club identity
              </h5>
            ...
            <Col xl={10}>
              <m.div {...fadeIn} className="row items-center">
                <Col
                  lg={5}
                  md={4}
                  className="text-center md:text-start sm:mb-[30px]"
                >
                  <img
                    height=""
                    width=""
                    className="sm:mx-auto"
                    src="https://via.placeholder.com/291x286"
                    alt=""
                  />
                </Col>
                <Col lg={6} md={8} className="text-center md:text-start">
                  <span className="text-darkgray text-[30px] text-left tracking-[-0.5px] leading-[40px] sm:text-center font-serif inline-block sm:leading-[30px] font-medium mb-[40px] sm:mb-[30px] sm:text-[20px]">
                    Gents club is a eCommerce brand based on London. One of our
                    latest projects.
                  </span>
                    ...
                    modalBtn={
                      <div className="flex items-center">
                        <Buttons
                          ...
                          size="sm"
                          className="btn-sonar"
                          themeColor={["#232323", "#232323"]}
                          color="#ff6437"
                          title={<i className="icon-control-play !ml-[4px]" />}
                        />
                        <span className="font-medium font-serif text-md text-darkgray uppercase cursor-pointer border-b border-solid border-darkgray no-underline ml-[15px] hover:text-darkgray">
                          WATCH A PROJECTS
                        </span>
                      </div>
                    }
                ...
                <Col lg={12}>
                  <div className="w-full h-[1px] bg-mediumgray opacity-70 my-[6.5rem] sm:my-[5rem]"></div>
                </Col>
                <Col className="font-serif uppercase leading-[12px]">
                  <Row>
                    <m.div
                      {...fadeIn}
                      className="col-12 col-md-3 col-sm-6 text-center font-medium uppercase text-sm leading-[12px] border-r border-mediumgray sm:mb-[30px] xs:border-none"
                    >
                      <span className="inline-block md:mb-[10px] md:block font-serif">
                        Date:
                      </span>
                      <span className="text-darkgray font-medium uppercase font-serif">
                        {" "}
                        08 January 2020
                      </span>
                    </m.div>
                    <m.div
                      ...
                      className="col-12 col-md-3 col-sm-6 text-center border-r font-medium uppercase text-sm leading-[12px] border-mediumgray sm:border-none sm:mb-[30px]"
                    >
                      <span className="inline-block md:mb-[10px] md:block font-serif">
                        client:
                      </span>
                    ...
                    <m.div
                      ...
                      className="col-12 col-md-3 col-sm-6 text-center border-r font-medium uppercase text-sm leading-[12px] border-mediumgray xs:border-none xs:mb-[30px]"
                    >
                      <span className="inline-block md:mb-[10px] md:block font-serif">
                        industry:
                      </span>
                    ...
                    <m.div
                      ...
                      className="col-12 col-md-3 col-sm-6 text-center font-medium uppercase text-sm leading-[12px]"
                    >
                      <span className="inline-block md:mb-[10px] font-serif md:block">
                        website:
                      </span>
                      <a
                        aria-label="themezaa"
                        className="text-darkgray text-sm font-medium uppercase leading-[0] font-serif hover:text-[#fd961e]"
        ...
        <Container fluid>
          <Row>
            <Col
              ...
              style={{
                backgroundImage: "url(https://via.placeholder.com/960x830)",
              }}
            ></Col>
            <Col
              md={6}
      ...
      <section className="py-[130px] lg:py-[90px] md:py-[75px] sm:py-[50px]">
        <Container>
          <Row className="justify-between">
            <m.div
              {...fadeIn}
              className="col-12 col-lg-4 col-md-7 col-sm-9 md:mb-[35px]"
            >
              <h6 className="font-serif text-darkgray font-medium m-0">
            ...
            >
              <div className="flex font-serif text-darkgray mb-[15px] font-medium">
                <span className="flex-shrink-0 self-center h-[1px] w-[40px] bg-[#ff6437] mr-[20px]"></span>
                <div className="grow">The Challenge</div>
              </div>
            ...
            >
              <div className="flex font-serif text-darkgray mb-[15px] font-medium">
                <span className="flex-shrink-0 self-center h-[1px] w-[40px] bg-[#ff6437] mr-[20px]"></span>
                <div className="grow">The Approach</div>
              </div>
              <p className="md:w-[80%] xs:w-full">
                Lorem ipsum is simply dummy text of the printing and typesetting
                industry. Lorem ipsum has been.
      ...
      <section className="relative bg-cover overflow-hidden bg-fixed h-[750px] md:h-[550px] sm:h-[350px]">
        <Parallax
          ...
          translateY={[-20, 20]}
          style={{
            backgroundImage: `url(https://via.placeholder.com/1920x1180)`,
          }}
        ></Parallax>
      </section>
      {/* Section End */}
      ...
      <section className="py-[130px] lg:py-[90px] md:py-[75px] sm:py-[50px]">
        <Container>
          <Row className="justify-center items-center md:items-start mb-[35%] md:mb-[43%] sm:mb-0">
            <m.div
              {...fadeIn}
              className="col-12 col-lg-2 text-left md:text-center md:mb-[35px]"
            >
              <img
                height=""
                width=""
            ...
            <m.div
              {...{ ...fadeIn, transition: { delay: 0.5 } }}
              className="col-12 col-xl-5 col-md-6 col-sm-11 sm:text-start sm:mb-[30px] xs:text-center"
            >
              <span className="font-serif text-darkgray text-[30px] tracking-[-0.5px] leading-[40px] font-medium inline-block xs:w-[95%] xs:mx-auto sm:text-[20px] sm:leading-[30px] sm:text-center">
                For men shoes are the most important. Good shoes take you good
                places
              </span>
            </m.div>
            <m.div
              {...{ ...fadeIn, transition: { delay: 0.6 } }}
              className="col-12 col-lg-4 offset-xl-1 col-md-6 col-sm-10 sm:text-center"
            >
              <span className="font-serif text-darkgray text-base font-medium mb-[15px] inline-block">
                Design and style above average
              </span>
              <p>
                Lorem ipsum is simply dummy text of the printing and typesetting
      ...
      <section className="bg-lightgray pb-[130px] lg:pb-[90px] md:pb-[75px] sm:py-[50px]">
        <Container className="sm:mb-[50px]">
          <Row className="justify-center">
            <Overlap>
              <Col xl={12} className="text-center mb-[100px] relative">
                <img
                  height=""
                  width=""
                  src="https://via.placeholder.com/1110x700"
                  alt=""
                  className="border-[10px] border-white w-full shadow-[0_0_25px_rgba(0,0,0,0.08)]"
                />
                {/* Modal Component Start */}
                <CustomModal.Wrapper
            ...
            <m.div
              {...fadeIn}
              className="col-12 col-xl-5 col-lg-6 col-md-8 col-sm-10 text-center"
            >
              <i className="ti-quote-left text-[#ff6437] text-[50px] mb-[25px] block"></i>
              <span className="text-xlg text-darkgray leading-[34px] font-serif block mb-[25px] lg:text-[18px] lg:leading-[24px] md:leading-[26px]">
                A shoe that is too large is apt to trip one and when too small
                to pinch the feet so it is with those whose fortune does not
                suit them.
              </span>
              <span className="font-serif uppercase text-sm font-medium tracking-[4px]">
                James nichols
              </span>
            </m.div>
          </Row>
          ...
          <Row>
            <Col>
              <img
                height=""
                width=""
                src="https://via.placeholder.com/1140x612"
      ...
      {/* Section Start */}
      <section
        className="p-0 bg-cover bg-no-repeat h-[900px] overflow-hidden bg-center lg:h-[700px] md:h-[550px] xs:h-[300px]"
        style={{
          backgroundImage: "url('https://via.placeholder.com/1919x917')",
        }}
      ></section>
      {/* Section End */}
          ...
          <Row className="items-center justify-center">
            ...
            >
              <figure className="relative m-0">
                <img
                  height=""
                  width=""
                  src="https://via.placeholder.com/570x389"
                  alt=""
                />
                <figcaption className="absolute bg-[#ff6437] bottom-[-20px] left-[-50px] text-white p-[49px] lg:p-[45px] md:p-[42px] sm:p-[38px] w-[50%] xs:w-full xs:left-[-25px]">
                  ...
                  <h6 className="font-serif uppercase font-medium mb-0">
                    Branding strategy and innovation
                  </h6>
                </figcaption>
              </figure>
            </Col>
            <Col xl={{ span: 4, offset: 1 }} lg={5} md={9}>
              ...
              <p className="mb-[25px] md:mb-[20px] sm:mb-[15px]">
                When an unknown printer took a galley of scrambled only five
                centuries, but also electronic typesetting. Lorem ipsum is
