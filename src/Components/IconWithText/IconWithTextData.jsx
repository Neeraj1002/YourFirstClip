...
const IconWithTextData_08 = [
  {
    ...
    title: "Powerful Editing Solutions",
    content:
      "From grammar and clarity to tone and structure, we ensure your writing is polished to perfection.",
  },
  {
    icon: "line-icon-Sand-watch2",
    title: "Unlimited Revisions",
    content:
      "We work with you until it’s just right—refining your content with as many revisions as needed.",
  },
  {
    icon: "line-icon-Idea-5",
    title: "Strategic Content Enhancement",
    content:
      "We don’t just edit—we elevate. Our expert editors craft content that aligns with your goals and resonates with your audience.",
  },
];
